...
var x_formula = new Formula('v*cos(u)');
// x_formula = new Formula(x_input.value);
var y_formula = new Formula('v*sin(u)');
var z_formula = new Formula('u');
...
view_matrix[14] = view_matrix[14] - 7;
...
var animate = function(time) {
    ...
    //view_matrix[14] = view_matrix[14] - 0.005
